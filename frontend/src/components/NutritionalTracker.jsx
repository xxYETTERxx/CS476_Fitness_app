                    ...
                    <div className='flex-container justify-between text-2xl font-medium b h-1/6 items-center'>
                        <h2 className = "mb-10">Food and Water Consumption</h2> 
                            ...
                            <form id="trackerForm" onSubmit= {handleSubmit}>
                                <label className="input input-bordered flex items-center gap-2 mb-4" htmlFor="waterIntake (in ml)">Water Intake (ml):

                                <input type="number" id="waterIntake" name="waterIntake" value={waterIntake} onChange={(e)=>setWaterIntake(e.target.value)} />
                                </label>
                                <br></br>
                                <label className="input input-bordered flex items-center gap-2 mb-4" htmlFor="caloriesConsumed">Calories Consumed:
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-start', gap: '10px', width: '100%' }}>
                                    <button onClick={addFoodtoList} className="btn btn-neutral mt-20" type="button">Add Food</button>
                                    <div style={{ flexGrow: 1, display: 'flex', alignItems: 'center', justifyContent: 'flex-end' }}>
                                    <span className='mt-20'>Grams:</span>
                                    <input className= 'mt-20 bg-white' type="number" id="calories" name="calories" value={grams} onChange={(e)=>setGrams(e.target.value)} style={{ width: '100px' }} />
                                </div>
                                </div>
