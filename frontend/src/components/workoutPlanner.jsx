                ...
                <div className="flex flex-col w-full lg:flex-row">
                    <div className="grid flex-grow h-35 card bg-base-300 rounded-box place-items-center">
                        <div className='flex justify-between text-2xl font-medium b h-1/2 items-center'>
                            <h2 className="mb-3.5">Workout Planner</h2>
                        </div>
                        ...
                        <form id="trackerForm" onSubmit={handleSubmit}>
                            ...
                            <textarea type="text" id="description" name="description" className="textarea textarea-bordered textarea-lg w-full max-w mb-2" value={description} onChange={(e) => setDescription(e.target.value)} placeholder="Type here..." />

                            <div>
                                <label for="dayOfTheWeek">Day of Week:</label>
                                <select className="select select-primary w-full max-w-xs mb-4" value={daySelected} onChange={(e) => handleOptionSelect(e.target.value)}>
